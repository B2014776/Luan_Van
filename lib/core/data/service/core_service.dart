...
import 'package:agri_shop/core/data/service/dio_config.dart';
...
class CoreService {
  ...
  Future<Result<T>> request<T>({
    ...
    try {
      ...
      var path = "https://api-luan-v1.onrender.com/api/v1/$endpoint";
      final response = await _makeRequest(method, path, data);
